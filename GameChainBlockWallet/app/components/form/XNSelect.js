...
class XNSelect extends BaseComponent {
    ...
    render() {
            ...
            <div className="select-input-popup">
                <ul>
                    {this.state.data.map((item, i) => {
                        return (<li key={i}>
                            <span className="span_walletName" onClick={this.onItemClick.bind(this, item)}>{item.text}</span>
                            {
                ...
                </ul>
                {
                    this.props.isAdd === false ? null : (
                        <div>
                            ...
                            <Icon type="plus-circle-o" />{this.formatMessage('settings_add')}</span>
                        </div>
                    )
                }
            </div>
        ...
        return (
            <div className="select-input XNSSelect" onClick={this.openList.bind(this)}>
                <div>
