...
class SettingsStore extends BaseStore {
    constructor() {
        ...
        this.defaultSettings = Immutable.Map({
            locale: "zh",
            apiServer:"ws://47.100.57.210:8090",
            faucet_address: "http://47.100.57.210:3000",
            // apiServer:"ws://192.168.0.137:8091",
            // faucet_address: "http://192.168.0.137:3000",
        ...
        let topMarkets = [
            "OPEN.MKR", CORE_ASSET, "OPEN.ETH", "ICOO", "BTC", "OPEN.LISK", "BKT",
        ...
        //    {value: "https://bit.btsabc.org", text: "https://bit.btsabc.org"},
           // {value: "https://bitshares.openledger.info", text: "https://bitshares.openledger.info"}
            //{value:"http://116.62.211.176:3000", text: "zkc_Faucet"},
            // {value:"http://192.168.0.137:3000", text: "ZKC_Faucet137"},
            
            // {value:"http://192.168.0.240:3000", text: "192.168.0.240:3000"}
            // {value:"http://192.168.5.171:3000", text: "ZKC_Faucet"},

		     {value: "http://47.100.57.210:3000", text: "GCS_Faucet"},
        ];
        let apiServer = [
            // {value: "ws://192.168.5.171:8090", text: "ZKC_Server"},

            {value: "ws://47.100.57.210:8090", text: "GCS_Server"},
           // {value: "ws://192.168.0.137:8091", text: "ZKC_Server137"},
            
            // {value: "ws://192.168.0.240:8090", text: "192.168.0.240:8090"}//,            
			// {value: "ws://192.168.0.240:8090", text: "my node1"},
