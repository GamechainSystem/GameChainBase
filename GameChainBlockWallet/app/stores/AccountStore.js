...
class AccountStore extends BaseStore {
    constructor() {
        ...
        this.bindListeners({
            ...
            onSetGlobalLoading: AccountActions.setGlobalLoading,
            onSetCurrentBlockInfo: AccountActions.setCurrentBlockInfo
    ...
    */
    ...
    onSetGlobalLoading(b){
        this.state.gloablLoaingStatus=b;
    }
    
    onSetCurrentBlockInfo(blockInfo){
        this.state.currentBlockInfo=blockInfo;
    }
